...
import { UserData, PageRoute } from '../types';
...
export const CheckoutPage: React.FC<{ onNavigate: (r: PageRoute) => void }> = ({ onNavigate }) => {
...
${formData.city}/${formData.state} - CEP: ${formData.cep}
...
*Frete (Est.):* ${formatCurrency(shippingCost)}
*TOTAL:* ${formatCurrency(total)}
--------------------------------

*💳 Pagamento:* ${formData.paymentMethod.toUpperCase()}
*🚚 Entrega:* ${formData.deliveryMethod === 'shipping' ? 'Envio' : 'Retirada Balcão'}
${formData.notes ? `\n*📝 Observações:* ${formData.notes}` : ''}

_Aguardo confirmação de disponibilidade e frete!_`;
